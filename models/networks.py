...
def init_net(net, init_type="normal", init_gain=0.02, opt=None):
    ...
    if opt.use_ddp:
        net = torch.nn.parallel.DistributedDataParallel(
            net, device_ids=[opt.local_rank], output_device=opt.local_rank, broadcast_buffers=False)
    return net
...
def define_G(
    ...
    return init_net(net, init_type, init_gain, opt)
